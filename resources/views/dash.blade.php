						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="{{route('alert.create')}}" method="post">
									...
									<input name="alert_body" class="form-control" type="text" placeholder="What do you urgently want to say?" id="alertBody" required><br>
									...
									<div class="form-row">
										<div class="col">
											...
											<input name="start_date" class="form-control" type="date" id="alertStartDate" required><br>
										</div>
										<div class="col">
											<label class="form-check-label" for="alertStartTime">Time Alert Starts</label>
											<input name="start_time" class="form-control" type="time" id="alertStartTime" required><br>
										</div>
									</div>
									<div class="form-row">
										<div class="col">
											<label class="form-check-label" for="alertEndDate">Date Alert End</label>
											<input name="end_date" class="form-control" type="date" id="alertEndDate" required><br>
										</div>
										<div class="col">
											<label class="form-check-label" for="alertEndTime">Time Alert Ends</label>
											<input name="end_time" class="form-control" type="time" id="alertEndTime" required><br>
										</div>
									</div>
							</div>
