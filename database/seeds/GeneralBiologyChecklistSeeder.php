...
class GeneralBiologyChecklistSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
		...
		[
			...
			'body' => 
'<strong>Total number of units: 150-157 units</strong>',
			'created_at' => now(),
			'updated_at' => now()
        ],
		[
...
'<table class="table table-striped" id="3rd-2nd" style="border-collapse: collapse;">
	...
	<tbody>
		...
		<tr>
			<td>Ecology Elective</td>
			<td style="text-align: center;">3-5</td>
		</tr>
		<tr>
			<td>Botany Elective</td>
			<td style="text-align: center;">3</td>
		</tr>
	</tbody>
	<tfoot>
...
'<table class="table table-striped" id="list-course" style="border-collapse: collapse;">
	<thead>
		<tr>
			<td style="text-align: center;" colspan="4"><strong>List of Courses in the BS Biology (General Biology) Program</strong></td>
		</tr>
	</thead>
	<tbody>
		<tr>
